<div class="property-style-7">
    <a target="<?php echo esc_attr($target); ?>" href="<?php echo get_permalink($property_id); ?>" class="img-container" style="background-image:url(<?php echo get_the_post_thumbnail_url($property_id); ?>)">
