				...
				<div class="col-sm-12 col-md-12">
					...
					<div class="info-block" id="images">
						...
						<p style="text-align: center">
							<button class="btn btn-default upload_image_button" data-title="<?php _e( 'Select images for property gallery', 'real-estate-manager' ); ?>" data-btntext="<?php _e( 'Insert', 'real-estate-manager' ); ?>">
